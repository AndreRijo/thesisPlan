...
The query issue is further exacerbated when we consider recurring queries, specially analytic or OLAP queries \cite{dbtoaster,viewSelection}.
...
\todo{I didn't mention anything to motivate different consistency levels or invariants. And I think the motivation text is too long. On the other hand, the proposed solution is shorter.}
...
\todo{I don't think I need an expected contributions page anymore? I already mention what is novel and indirectly what is our main contributions. Chapter \ref{cha:research_statement} will detail this more anyway}
