...
%If a client transaction accesses data that is all mastered in the same datacenter, and the client is close to it (data locality), then SLOG provides low latency as it commit
