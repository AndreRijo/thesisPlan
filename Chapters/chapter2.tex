...
View maintenance is a common research topic. \todo{I think this last sentence does not need a citation given what I already cited before, but I can list them all again} %Maybe just re-add citations speciallized on this.
...
%TODO: For Dynamo, cut content if needed. It's not really that relevant, I'm mostly describing it because it's a "standard". Atm it has 13+6=19 lines, aim to ~12. (at worst 14)

%Now it is at 10+4. Not bad!
...
Dynamo applies a fully decentralized P2P structure.
...
Dynamo emphasizes 99.9% latency, resilience, availability, and durability.
